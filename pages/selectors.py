enter_button_selector: str = 'a[class*=enter]'
...
disk_button_in_card_menu_selector: str = 'a[data-statlog*="login.disk"]'
...
user_header_button_selector: str = 'div.PSHeader-User'
user_menu_links_selector: str = 'ul.menu > ul > li, div.legouser__multi-auth, div.legouser__menu-footer > a'
